...
def __update_contracts_get_contracts():
...
def update_contracts():
    interesting = [
        x for x in __update_contracts_get_contracts()
        if x['type'] == 'courier'
    ...
    Entity.objects.bulk_resolve(char_set - set(Entity.objects.values_list('id', flat=True)))
        ...
        for i in interesting:
            Contract.objects.update_or_create(
                ...
                defaults={
                    ...
                    'acceptor': Entity.objects.get(id=i['acceptor_id']) if i['acceptor_id'] != 0 else None,
